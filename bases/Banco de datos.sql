...
insert into EMPLOYEE(employee_name,institutional_mail,direction,employee_type,employee_user,employee_password) 
	values ('Roberto Ramirez','roberC123@gob.sv','Casa 23A, Cima 1, San Salvador','gestor','alejandrogob039','yejxb010');
insert into EMPLOYEE(employee_name,institutional_mail,direction,employee_type,employee_user,employee_password)
	values ('Enrique Pania','enrique05@gob.sv','Pasaje 3, Colonia Miramonte','gestor','enriquegob1003','ueybeu32');
insert into EMPLOYEE(employee_name,institutional_mail,direction,employee_type,employee_user,employee_password) 
	values ('Josue Machado','machado2828@gob.sv','Casa 12, Colonia Buenos Aires','gestor','josuegob399','iiene9se');
...
insert into CABIN( direction,phone,manager_name,mail) values ('(ISSS) Santa Ana','50325838395','Enrique pania','cabina2SA@gob.sv');
insert into CABIN( direction,phone,manager_name,mail) values ('Hospital Rosales, San Salvador','50324568785','Josue Machado','cabinaRosales@gob.sv');
